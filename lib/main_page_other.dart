...
class ShowOtherPage extends StatefulWidget{
  @override
  ShowOtherPageState createState() => ShowOtherPageState();
}
class ShowOtherPageState extends State<ShowOtherPage>{
